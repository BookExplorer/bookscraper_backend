...
@pytest.mark.parametrize("country", VALID_FORMER_COUNTRIES+VALID_EXISTING_COUNTRIES)
def test_city_check_constraint_both(db_session_factory: SessionFactory, country: db_models.Country) -> None:
    """
...
@pytest.mark.parametrize("country", VALID_FORMER_COUNTRIES+VALID_EXISTING_COUNTRIES)
def test_city_uq_city_region(db_session_factory: SessionFactory, country: db_models.Country) -> None:
...
@pytest.mark.parametrize("country", VALID_FORMER_COUNTRIES+VALID_EXISTING_COUNTRIES)
def test_city_uq_city_country(db_session_factory: SessionFactory, country: db_models.Country) -> None:
...
@pytest.mark.parametrize("country", VALID_FORMER_COUNTRIES+VALID_EXISTING_COUNTRIES)
def test_linked_creation(db_session_factory: SessionFactory, country:db_models.Country) -> None:
...
@pytest.mark.parametrize("country", VALID_FORMER_COUNTRIES+VALID_EXISTING_COUNTRIES)
def test_linked_creation_repeats(db_session_factory: SessionFactory, country:db_models.Country) -> None:
    """This test should verify that commiting just an author linked to other classes creates everything IF EVERYTHING IS CORRECT.
